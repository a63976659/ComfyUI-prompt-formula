...
# 摄像机角度选项
CAMERA_ANGLES = [
    "30度", "45度", "60度", "90度", "120度", "180度", "270度"
]
...
CULTURAL_PRODUCT_DESCRIPTIONS = {
    ...
    "T恤图案": "时尚的T恤印花图案，设计潮流，穿着舒适",
    "手机壳": "个性化的手机壳设计，图案清晰，保护性好",
    "帆布袋": "环保帆布袋，图案印刷精美，实用耐用",
    "明信片": "艺术明信片，背面可书写，适合收藏",
    "贴纸": "可爱贴纸套装，多种尺寸，可随处粘贴",
    "钥匙扣": "小巧钥匙扣，精致可爱，日常实用",
    "徽章": "金属徽章，别针设计，可别在衣物上",
    "抱枕": "柔软抱枕，印花清晰，抱着舒适",
    "马克杯": "陶瓷马克杯，图案耐高温，日常使用",
    "笔记本": "创意笔记本，封面设计独特，内页实用",
    "书签": "精美书签，设计巧妙，阅读好伴侣",
    "海报": "艺术海报，印刷精美，适合装饰",
    "挂画": "墙面挂画，画框精致，提升空间美感",
    "地毯": "柔软地毯，图案清晰，脚感舒适",
...
# 图像编辑类型选项
IMAGE_EDITING_TYPES = [
    "照片修复", "照片上色", "线稿上色", "图像转线稿", "图像转深度图", 
    "图像转姿态图", "图像转四边面网格", "图像转三角面网格", "图像超分辨率",
    "图像去噪", "图像去模糊", "图像对比度增强", "图像色彩校正", "图像背景移除",
    "图像镜像翻转","图像像素化", "图像马赛克", "图像重新打光",  "产品精修", 
    "图像光照调整", "图像阴影修复", "图像透视校正", "图像畸变校正",
    "图像HDR效果", "图像黑白化", "图像复古效果", "图像胶片颗粒效果", "图像运动模糊"
]
...
IMAGE_EDITING_DESCRIPTIONS = {
    ...
    "图像转线稿": "提取图像轮廓，生成清晰的线稿",
    "图像转深度图": "生成深度信息图，表现物体的远近关系",
    "图像转姿态图": "提取人体姿态关键点，生成姿态骨架图",
    "图像转四边面网格": "将图像转换为四边形网格，用于3D建模",
    "图像转三角面网格": "将图像转换为三角形网格，优化3D模型结构",
    "图像超分辨率": "提升图像分辨率，增强细节清晰度",
    "图像去噪": "去除图像噪点，保持细节完整",
    "图像去模糊": "修复模糊图像，恢复清晰边缘",
    "产品精修": "去除背景中的杂质，产品降噪，产品精修",
    "图像对比度增强": "调整图像对比度，使图像更加鲜明",
    "图像色彩校正": "校正色彩偏差，还原真实色彩",
    "图像背景移除": "移除图像背景，保留主体对象",
    "图像像素化": "将图像转换为像素艺术",
    "图像马赛克": "为图像添加马赛克效果",
    "图像重新打光": "产品重新打光，光影艺术",
    "图像光照调整": "调整图像光照效果，改善明暗关系",
    "图像阴影修复": "修复阴影区域，提升整体亮度",
    "图像透视校正": "校正图像透视变形",
    "图像畸变校正": "校正镜头畸变，还原真实比例",
    "图像HDR效果": "应用高动态范围效果，增强色彩层次",
    "图像黑白化": "将彩色图像转换为黑白",
    "图像复古效果": "添加复古滤镜，营造怀旧氛围",
    "图像胶片颗粒效果": "添加胶片颗粒质感",
    "图像运动模糊": "添加运动模糊效果，表现动态感"
}