...
try:
    ...
    字符串输入反转 = 图像输入反转 = 合并多组提示词 = 提取视频结束帧 = 基础图像加载器 = 空图像防报错 = 判断并输出加载的图像 = 批量判断并输出同名图像 = 工具节点占位符

# 导入千问编辑节点
try:
    from 千问编辑 import (
        千问单图编辑_改变视角,  # 修改后的节点名称
        千问单图编辑_改变镜头, 
        千问单图编辑_人物换动作,
        千问单图编辑_物品换材质,
        千问单图编辑_图像变文创产品,
...
NODE_CLASS_MAPPINGS = {
    ...
    "提取视频结束帧": 提取视频结束帧,
    "空图像防报错": 空图像防报错,
    "判断并输出加载的图像": 判断并输出加载的图像,  # 新增节点
    "批量判断并输出同名图像": 批量判断并输出同名图像,  # 新增节点
    # 千问编辑
    "千问单图编辑-改变视角": 千问单图编辑_改变视角,  # 修改后的节点名称
    "千问单图编辑-改变镜头": 千问单图编辑_改变镜头,  # 新增节点
    "千问单图编辑-人物换动作": 千问单图编辑_人物换动作,
    "千问单图编辑-物品换材质": 千问单图编辑_物品换材质,
    "千问单图编辑-图像变文创产品": 千问单图编辑_图像变文创产品,
    "千问单图编辑-图像转绘": 千问单图编辑_图像转绘,
    "千问单图编辑-图像编辑": 千问单图编辑_图像编辑,  # 新增节点
}
