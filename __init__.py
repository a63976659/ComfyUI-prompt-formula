...
try:
    ...
    千问提示词编辑_改变视角 = 千问提示词编辑_改变镜头 = 千问提示词编辑_人物换动作 = 千问提示词编辑_物品换材质 = 千问提示词编辑_图像变文创产品 = 千问提示词编辑_图像转绘 = 千问提示词编辑_图像编辑 = 千问编辑占位符
...
NODE_CLASS_MAPPINGS = {
    ...
    "合并多组提示词": 合并多组提示词,
    # 千问编辑
    "千问提示词编辑-改变视角": 千问提示词编辑_改变视角,  # 修改后的节点名称
    "千问提示词编辑-改变镜头": 千问提示词编辑_改变镜头,  # 新增节点
    "千问提示词编辑-人物换动作": 千问提示词编辑_人物换动作,
    "千问提示词编辑-物品换材质": 千问提示词编辑_物品换材质,
    "千问提示词编辑-图像变文创产品": 千问提示词编辑_图像变文创产品,
    "千问提示词编辑-图像转绘": 千问提示词编辑_图像转绘,
    "千问提示词编辑-图像编辑": 千问提示词编辑_图像编辑,  # 新增节点
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "合并多组提示词": "合并多组提示词",
    # 千问编辑
    "千问提示词编辑-改变视角": "千问提示词编辑-改变视角",  # 修改后的节点名称
    "千问提示词编辑-改变镜头": "千问提示词编辑-改变镜头",  # 新增节点
    "千问提示词编辑-人物换动作": "千问提示词编辑-人物换动作",
    "千问提示词编辑-物品换材质": "千问提示词编辑-物品换材质",
    "千问提示词编辑-图像变文创产品": "千问提示词编辑-图像变文创产品",
    "千问提示词编辑-图像转绘": "千问提示词编辑-图像转绘",
    "千问提示词编辑-图像编辑": "千问提示词编辑-图像编辑",  # 新增节点
}
